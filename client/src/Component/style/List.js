        ...
        <div style={{
            ...
            <div className="scrollBarList"
                ...
                {StyleList.map((style, idx) => (
                    <div key={idx}
                         style={{marginBottom: '20px', width: '224px', marginRight: '10px', marginLeft: '10px'}}>
                        <Card>
                            {style.image && style.image.length > 0 &&
                                <Card.Img variant="top" src={style.image[0]}
                ...
                <div style={{marginBottom: '20px', width: '224px', marginRight: '10px', marginLeft: '10px'}}>
                        ...
                        <Card>
                            ...
                            <Card.Body>
                                ...
                                <Link to="/upload">
                                <Button variant="dark" style={{marginTop: '20px'}}>Add</Button>
                                </Link>
                            </Card.Body>
                        </Card>
